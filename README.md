...
You will notice that this repo doesn't have any starter code, this is on purpose.  You are to start from scratch using any files you have built throughout your time here at Lambda School.  Refer to the design files in this repository. Use them as a creative guide:

## List View
![List View](front-end-project-designs/list-view.png)

## Create New View
![Create New View](front-end-project-designs/create-new-view.png)

## Note View
![Note View](front-end-project-designs/note-view.png)
